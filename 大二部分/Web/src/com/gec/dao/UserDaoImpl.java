...
public class UserDaoImpl implements UserDao{
	...
	public void db_insert_user(String account, String password)
			throws Exception {
		// TODO Auto-generated method stub
		String sql="insert into user(account,password,type,flag)values(?,?,0,?)";
	    PreparedStatement pstmt=(PreparedStatement) DataConnect.getcon().prepareStatement(sql);
		pstmt.setString(1,account);
	...
	public ArrayList<St_full_course> db_select_My_course(String account)
		...
		while(rs.next()) {
			st_full_course.add(new St_full_course(rs.getString(1),rs.getString(2),
					rs.getInt(3),rs.getString(4),rs.getString(5),rs.getInt(6),rs.getFloat(8),rs.getString(9)));	
		}
	...
	public void db_insert_flag(String account) throws Exception {
		// TODO Auto-generated method stub
		String sql ="update user set flag = 1 where account =?";
		PreparedStatement pstmt=(PreparedStatement)DataConnect.getcon().prepareStatement(sql);
		pstmt.setString(1,account);
		pstmt.executeUpdate();
	}
